...
.factory('Chats', function() {
  ...
  var chats = [{
    ...
    face: 'https://www.youtube.com/embed/eItCt0dMJ3U'
  }];
...
.service('LoginService', function($q) {
    return {
        loginUser: function(name, pw) {
            ...
            if (name == 'superAdmin' && pw == 'Today123') {
